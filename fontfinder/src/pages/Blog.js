...
const POSTS = [
  ...
  // ── NEW BATCH — SEO + Design + Tips ──────────────────────
  {
    slug: 'how-to-identify-font-from-image',
    category: 'Tutorial',
    title: 'How to Identify Any Font From an Image in Seconds',
    excerpt: 'Step-by-step guide to identifying fonts from screenshots, photos, logos, and packaging — even when the text is blurry or at an angle. No design experience needed.',
    date: 'March 2025',
    readTime: '4 min read',
  ...
  {
    slug: 'best-free-fonts-for-logos',
    category: 'Roundup',
    title: '15 Best Free Fonts for Logo Design in 2025',
    excerpt: 'Professional logo fonts that cost nothing. We picked 15 free typefaces that look expensive, pair beautifully, and work across print and digital — all OFL licensed.',
    date: 'March 2025',
    readTime: '6 min read',
    icon: 'fa-star',
    color: '#fcd34d',
  ...
  },
  {
    ...
    excerpt: 'The oldest debate in typography — finally settled. We break down when to use serif, when to go sans, and how to tell them apart instantly in any image.',
    date: 'Feb 2025',
    readTime: '5 min read',
    icon: 'fa-font',
    color: '#c4b5fd',
  ...
  {
    slug: 'fonts-used-in-netflix-apple-spotify',
    category: 'Inspiration',
    title: 'The Exact Fonts Used by Netflix, Apple, Spotify and Airbnb',
    excerpt: 'We ran the logos and UI of the world\'s most valuable brands through FontFinder. Here are the exact typefaces they use and why they work so well.',
    date: 'Feb 2025',
    readTime: '7 min read',
    icon: 'fa-tv',
    color: '#f9a8d4',
  ...
  },
  {
    ...
    excerpt: 'Variable fonts are the biggest typography innovation in decades. One file replaces 20 font weights — here\'s how they work and which ones to use today.',
    date: 'Feb 2025',
    readTime: '5 min read',
    icon: 'fa-sliders',
    color: '#6ee7b7',
  ...
  {
    slug: 'how-to-use-google-fonts',
    category: 'Tutorial',
    title: 'How to Use Google Fonts on Any Website (The Right Way)',
    excerpt: 'Most developers implement Google Fonts wrong — causing slow load times and layout shifts. Here\'s the correct way to load, pair, and optimise Google Fonts for performance.',
    date: 'Jan 2025',
    readTime: '5 min read',
    icon: 'fa-globe',
    color: '#818cf8',
  ...
  {
    slug: 'font-pairing-guide-beginners',
    category: 'Design',
    title: 'The Beginner\'s Guide to Font Pairing: 10 Combinations That Always Work',
    excerpt: 'Choosing two fonts that work together is one of the hardest design skills to learn. These 10 proven pairings will make your designs look professional immediately.',
    date: 'Jan 2025',
    readTime: '6 min read',
  ...
  {
    slug: 'typography-mistakes-designers-make',
    category: 'Design',
    title: '7 Typography Mistakes Even Experienced Designers Make',
    excerpt: 'Wrong line height, bad kerning, too many fonts, incorrect hierarchy — these are the typography errors that silently kill your designs. Here\'s how to fix each one.',
    date: 'Dec 2024',
    readTime: '6 min read',
  ...
  },
  {
    ...
    excerpt: 'Brand logos are the most common font identification challenge. We show you 3 methods — from AI tools to manual matching — that work even on low-resolution images.',
    date: 'Dec 2024',
    readTime: '5 min read',
    icon: 'fa-image',
    color: '#67e8f9',
  ...
  {
    slug: 'best-fonts-for-websites-2025',
    category: 'Roundup',
    title: 'The 20 Best Fonts for Websites in 2025 (Free & Premium)',
    excerpt: 'Web-safe, fast-loading, and beautiful — these are the typefaces top designers are using for body text, headings, and UI elements right now. Updated for 2025.',
    date: 'Nov 2024',
    readTime: '8 min read',
    icon: 'fa-laptop',
    color: '#c4b5fd',
      ...
      <div class="inner-hero">
        ...
        <div class="container inner-hero__inner">
          ...
          <div class="blog-hero-stats">
            ...
            <span class="blog-hero-stat"><i class="fa fa-tags"></i> Trends · Tech · Design · Tutorials · Roundups</span>
          </div>
        </div>
      </div>
